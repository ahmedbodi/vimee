...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s vimee-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vimee-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vimee transaction") + "\n" +
              "  vimee-tx [options] -create [commands]   " + _("Create hex-encoded vimee transaction") + "\n" +
              "\n";
