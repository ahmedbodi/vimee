...
const char * const BITCOIN_CONF_FILENAME = "vimee.conf";
const char * const BITCOIN_PID_FILENAME = "vimeed.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Vimee";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Vimee";
#else
    // Unix
    return pathRet / ".vimee";
#endif
#endif
}
