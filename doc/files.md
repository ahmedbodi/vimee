...
* vimee.conf: contains configuration settings for vimeed or vimee-qt
* vimeed.pid: stores the process id of vimeed while running
...
* debug.log: contains debug information and general logging generated by vimeed or vimee-qt
